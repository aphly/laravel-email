...
<div class="imain">
    <div class="itop ">
        <form method="get" action="/email_admin/site/index" class="select_form">
        ...
        <div class="">
            <a class="badge badge-primary ajax_html show_all0_btn" data-href="/email_admin/site/form">添加</a>
        </div>
    </div>

    <form method="post"  @if($res['search']['string']) action="/email_admin/site/del?{{$res['search']['string']}}" @else action="/email_admin/site/del" @endif  class="del_form">
    @csrf
